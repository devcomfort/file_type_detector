...
def test_spec_compliant_archive_generators(tmp_path):
    ...
    s_magic, inodes, mkfs_time, block_size, fragments = struct.unpack("<IIIII", snap_bytes[0:20])
    compression, block_log, flags, no_ids, s_major, s_minor = struct.unpack("<HHHHHH", snap_bytes[20:32])
